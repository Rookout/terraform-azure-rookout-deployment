...
4. Get your organization's Rookout token from the [Rookout web application](https://www.app.rookout.com). The token must be pass it as a variable to the module you will be creating.
   ```
   rookout_token = "..."
   ```
